...
import kotlinx.android.synthetic.main.activity_description.toolbar as toolbar1
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            if (isFav){
                                ...
                                val noFavColor=ContextCompat.getColor(applicationContext,R.color.colodraw)
